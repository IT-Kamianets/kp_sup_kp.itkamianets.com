...
export const companyProfile: CompanyProfile = {
	...
	image: _stringOrFallback(rawCompanyProfile.image, rawCompanyProfile.logo ?? '/social/home.png'),
	...
	logo: _stringOrFallback(rawCompanyProfile.logo, rawCompanyProfile.image ?? '/favicon.svg'),
...
function _normalizeSeoMetadata(profile: RawCompanyProfile): SeoMetadata {
	...
	const image = _stringOrFallback(
		metadata?.image,
		profile.image ?? profile.logo ?? '/social/home.png',
	);
